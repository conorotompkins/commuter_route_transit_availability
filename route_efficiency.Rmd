---
title: "Roughly Calculating Port Authority transit line efficiency"
...
Need to show how to summarize this (in munge_data.R)
```{r}
...
This code grabs the shapefile with the transit route stats and stop geometry. The core of the code that creates this data is this:
* calculate how many residents and jobs are in each census tract
* calculate which transit lines stops serve which census tracts
* summarize how many residents and jobs a transit line servers
```{r}
